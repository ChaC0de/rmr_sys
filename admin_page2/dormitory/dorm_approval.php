...
$sql1= "SELECT * FROM tb_dormitory INNER JOIN tb_landlord 
    ON tb_dormitory.u_ID=tb_landlord.u_ID 
    WHERE tb_dormitory.status = '0' ORDER BY createDate DESC";

$query1 = mysqli_query($conn, $sql1); //เก็บค่าที่ได้จากการ query ลงในตัวแปร $query
...
<head>
    ...
    <title>
    รายการหอพักที่ยื่นขอการอนุมัติ
    </title>
</head>
<body>
<div class="container-fluid">
    <div class="row">
        ...
        <div class="row gx-5">
          <div class="row">
            <div class="p-3 border bg-warning text-light px-5">หอพักที่รอการอนุมัติ</div>
            <div class="row">
      <p class="fs-5 text-end pe-5 mt-2"><?php echo "ผลลัพธ์ทั้งหมด $num1 รายการ"; ?></p>
        ...
        ?>
          ...
          <div class="col-sm-4 text-end">
                <h5 class="p-2 text-warning">สร้างเมื่อ: <?php echo $row1['createDate']; ?></h5>
                  ...
                  <br>
                  <br>
                    <a href="viewDorm.php?dorm_ID=<?php echo $row1['dorm_ID']; ?>" class="btn btn-outline-info">ดูเพิ่มเติม</a>
                  </div>
                </div>
              </div>
            </div>   

...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="row">
      <a href="editDorm.php?dorm_ID=<?php echo $row['dorm_ID']; ?>" class="text-end text-decoration-none">แก้ไขหอพัก</a>
    <div class="col px-5">
      <input type="hidden" value="<?=$row['dorm_ID']?>"> 
...
<hr>
    ...
    <form action="unapproved.php" method="post">
        <input type="hidden" name="dorm_ID" value="<?=$row['dorm_ID']?>"> 
        <input type="hidden" name="status" value="<?=$row['status']?>"> 
    <button type="submit" name="submit" class="btn btn-outline-danger">ถอนการอนุมัติ</button>
    </div>
        </form>
    <div class="col d-flex justify-content-start">
    <a href="deleteDorm.php?dorm_ID=<?php echo $row['dorm_ID']; ?>
    " class="btn btn-danger" onclick="return confirm('ต้องการลบหอพักนี้หรือไม่? การกระทำนี้ไม่สามารถยกเลิกได้')">ลบหอพักนี้</a>
    </div>      
    </div>
    </div>
    </div>

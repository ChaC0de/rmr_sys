                                ...
                                <td class="d-flex justify-content-end">
                                    <div class="col-4">
                                        <select name="status" class="form-select">
                                            <?php $checkform = "SELECT * FROM tb_form WHERE status = 1 ";
                                            $checkquery = mysqli_query($conn, $checkform);
                                            $checknum = mysqli_num_rows($checkquery);
                                            if ($checknum == 1) { ?>
                                                <option value="1" <?php if($row["status"] == 1) { echo "selected"; } ?> disabled>เปิดใช้งาน</option>
                                        ...
                                        <small class="text-danger px-3">*เปิดใช้งานได้เพียงครั้งละ 1 แบบสอบถาม</small>
                                    </div>
                                </td>
                            </tr>
                            <tr>

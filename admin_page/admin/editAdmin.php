...
$sql = "SELECT * FROM tb_admin
  INNER JOIN user 
  ON tb_admin.u_ID = user.u_ID WHERE tb_admin.u_ID = '" . $u_ID . "' ";
    ...
    <?php include('../../_navbar/adminNav.php')?>
        <div class="col-lg-9 col-md-8 mx-auto">
            ...
            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                <button class="btn btn-danger" type="button" onclick="javascript:window.location='profile_admin.php?u_ID=<?php echo $_SESSION['u_ID']; ?>';">ยกเลิก</button>

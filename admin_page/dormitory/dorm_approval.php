...
<head>
    ...
    <title>รายการหอพักที่รอการอนุมัติ</title>
</head>
<body>
    ...
    <div class="row">
        ...
        <div class="col-lg-9 col-md-8 mx-auto">
            <div class="container" id="approved">
                <div class="row gx-5">
                    <div class="col-12">
                        <div class="p-3 border bg-secondary text-light px-5">หอพักรอการอนุมัติ</div>
                    </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
                            <div class="card" style="width: 100%;">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="viewDorm.php?dorm_ID=<?php echo $row['dorm_ID']; ?>" class="btn btn-outline-info">ดูเพิ่มเติม</a>
                                </div>
                            </div>
                        </div>
                    <?php } ?>

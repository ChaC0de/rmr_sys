...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO tb_dormitory (land_name, dormName, dormPrice, dormPic, deposit, address, room, dormType, dormStyle, residentsType,
    service1, service2, service3, service4, service5, service6, service7, service8, service9, service10, service11)
    VALUES ('$land_name','$dormName','$dormPrice', '$dormPic', '$deposit','$address','$room','$dormType','$dormStyle','$residentsType',
    '$service1', '$service2', '$service3', '$service4', '$service5', '$service6', '$service7', '$service8', '$service9', '$service10', '$service11')";
